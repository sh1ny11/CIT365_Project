...
void ALab06Character::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ALab06Character::Move);
...
void ALab06Character::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ALab06Character::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
